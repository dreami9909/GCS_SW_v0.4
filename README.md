...
The common WP001 is the target-motion/ingress-ETA-predicted search center. The
live search planner is `RHP-FE-PF-PW-ARC`: its candidate library starts at half
...
included TEL continuously patrols a 3.25 km clockwise outer orbit around TP at
12 km/h, following just inside the yellow 3.33 km search boundary throughout the
